...
import { Activity, Globe, Settings, Moon, Sun, MinusCircle } from 'lucide-react';

export const Header: React.FC<{ onSettings?: () => void; darkMode: boolean; setDarkMode: (val: boolean) => void; onMinimizeChat?: () => void }> = ({ onSettings, darkMode, setDarkMode, onMinimizeChat }) => {
